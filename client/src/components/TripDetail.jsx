  ...
  return (
    <main>
      ...
      <header>
        ...
        <div>
          {isOwner && <button onClick={() => setModal("edit")}>Edit</button>}
                ...
                <li key={expense._id}>
                  ...
                  {(isOwner || String(expense.addedBy?._id || expense.addedBy) === String(user?._id)) && (
                    <span className="row-actions">
                      ...
                      <button className="link" onClick={() => deleteExpense(expense)}>Delete</button>
                    </span>
                  )}
                </li>
              ))}
              ...
              {files.map((file) => (
                <li key={file._id}>
                  ...
                  {(isOwner || String(file.uploadedBy?._id || file.uploadedBy) === String(user?._id)) && (
                    <button className="link" onClick={() => deleteFile(file)}>Delete</button>
                  )}
                </li>
              ))}
            </ul>
